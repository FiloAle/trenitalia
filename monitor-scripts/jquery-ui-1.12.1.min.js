...
(function (t) {
	...
	function a(e, i) {
		t.extend(e, i);
		for (let s in i) null == i[s] && (e[s] = i[s]);
		return e;
	}
	function r(t) {
		return function () {
			let e = this.element.val();
	...
	((t.cleanData = (function (e) {
		...
		(t.widget.bridge = function (e, i) {
			let s = i.prototype.widgetFullName || e;
			t.fn[e] = function (n) {
				let o = "string" == typeof n,
			...
			(t.expr &&
				...
				t.extend(t.effects, {
					...
					scaledDimensions: function (t, e, i) {
						...
						let s = "horizontal" !== i ? (e || 100) / 100 : 1,
	...
	(t.uiBackCompat !== !1 &&
		...
		(t.ui.formResetMixin = {
			_formResetHandler: function () {
				let e = t(this);
				setTimeout(function () {
					let i = e.data("ui-form-reset-instances");
					t.each(i, function () {
						this.refresh();
					});
				});
			...
			_bindFormResetHandler: function () {
				if (((this.form = this.element.form()), this.form.length)) {
					let t = this.form.data("ui-form-reset-instances") || [];
					(t.length ||
			...
			_unbindFormResetHandler: function () {
				if (this.form.length) {
					let e = this.form.data("ui-form-reset-instances");
		...
		t.widget("ui.menu", {
					...
					this._on({
						...
						"mouseenter .ui-menu-item": function (e) {
							if (!this.previousFilter) {
								let i = t(e.target).closest(".ui-menu-item"),
									s = t(e.currentTarget);
								i[0] === s[0] &&
									(this._removeClass(
			...
			_setOption: function (t, e) {
				if ("icons" === t) {
					let i = this.element.find(".ui-menu-icon");
			...
			_open: function (e) {
				let i = t.extend({ of: this.active }, this.options.position);
				(clearTimeout(this.timer),
					this.element
						.find(".ui-menu")
				...
				((this.isMultiLine =
					...
					this._on(this.menu.element, {
						...
						menuselect: function (e, i) {
							let s = i.item.data("ui-autocomplete-item"),
								n = this.previous;
		...
		t.extend(t.ui.autocomplete, {
			...
			filter: function (e, i) {
				let s = RegExp(t.ui.autocomplete.escapeRegex(i), "i");
	...
	(t.widget("ui.controlgroup", {
		...
		_buildSimpleOptions: function (t, e) {
			let i = "vertical" === this.options.direction,
				s = { classes: {} };
			return (
				(s.classes[e] = {
					middle: "",
		...
		_spinnerOptions: function (t) {
			let e = this._buildSimpleOptions(t, "ui-spinner");
			return (
		...
		_selectmenuOptions: function (t) {
			let e = "vertical" === this.options.direction;
			return {
				width: e ? "auto" : !1,
				classes: {
					middle: {
			...
			(this._addClass(
				...
				e.length &&
					(t.each(["first", "last"], function (t, s) {
						let n = e[s]().data("ui-controlgroup-data");
						if (n && i["_" + n.widgetName + "Options"]) {
							let o = i["_" + n.widgetName + "Options"](
								1 === e.length ? "only" : s,
							);
		...
		t.widget("ui.checkboxradio", [
			t.ui.formResetMixin,
			{
				...
				_readType: function () {
					let e = this.element[0].nodeName.toLowerCase();
					...
					(this._toggleClass(
						...
						"radio" === this.type &&
							this._getRadioGroup().each(function () {
								let e = t(this).checkboxradio("instance");
								e &&
									e._removeClass(
										e.label,
										"ui-checkboxradio-checked",
		...
		t.widget("ui.button", {
			...
			_setOptions: function (t) {
				let e = void 0 === t.showLabel ? this.options.showLabel : t.showLabel,
			...
			refresh: function () {
				let t = this.element.is("input, button")
	...
	(t.extend(s.prototype, {
		...
		_newInst: function (e, i) {
			let s = e[0].id.replace(/([^A-Za-z0-9_\-])/g, "\\\\$1");
			return {
				id: s,
				input: e,
				selectedDay: 0,
		...
		_refreshDatepicker: function (t) {
			let e = this._getInst(t);
			e && this._updateDatepicker(e);
		},
		_setDateDatepicker: function (t, e) {
			let i = this._getInst(t);
			i &&
				(this._setDate(i, e),
				this._updateDatepicker(i),
				this._updateAlternate(i));
		...
		parseDate: function (e, i, s) {
			...
			let n,
				...
				b = !1,
				y = function (t) {
					let i = e.length > n + 1 && e.charAt(n + 1) === t;
					return (i && n++, i);
				},
				w = function (t) {
					let e = y(t),
		...
		formatDate: function (t, e, i) {
			...
			let s,
				...
				h = function (e) {
					let i = t.length > s + 1 && t.charAt(s + 1) === e;
					return (i && s++, i);
				},
				l = function (t, e, i) {
					let s = "" + e;
		...
		_possibleChars: function (t) {
			let e,
				...
				s = !1,
				n = function (i) {
					let s = t.length > e + 1 && t.charAt(e + 1) === i;
					return (s && e++, s);
				};
		...
		_restrictMinMax: function (t, e) {
			let i = this._getMinMaxDate(t, "min"),
				s = this._getMinMaxDate(t, "max"),
				n = i && i > e ? i : e;
			return s && n > s ? s : n;
		},
		_notifyChange: function (t) {
			let e = this._get(t, "onChangeMonthYear");
			e &&
		...
		_getNumberOfMonths: function (t) {
			let e = this._get(t, "numberOfMonths");
		...
		_canAdjustMonth: function (t, e, i, s) {
			let n = this._getNumberOfMonths(t),
	...
	(t(document).on("mouseup", function () {
		...
		t.ui.plugin.add("draggable", "connectToSortable", {
			start: function (e, i, s) {
				let n = t.extend({}, i, { item: s.element });
				((s.sortables = []),
					t(s.options.connectToSortable).each(function () {
						let i = t(this).sortable("instance");
						i &&
							!i.options.disabled &&
							(s.sortables.push(i),
							i.refreshPositions(),
		...
		t.widget("ui.resizable", t.ui.mouse, {
			...
			_hasScroll: function (e, i) {
				...
				let s = i && "left" === i ? "scrollLeft" : "scrollTop",
					n = !1;
		...
		t.widget("ui.dialog", {
			...
			_keepFocus: function (e) {
				function i() {
					let e = t.ui.safeActiveElement(this.document[0]),
					...
					this._on(this.uiDialog, {
						keydown: function (e) {
							...
							if (e.keyCode === t.ui.keyCode.TAB && !e.isDefaultPrevented()) {
								let i = this.uiDialog.find(":tabbable"),
									s = i.filter(":first"),
									n = i.filter(":last");
			...
			_makeDraggable: function () {
				...
				this.uiDialog.draggable({
					...
					stop: function (n, o) {
						let a = o.offset.left - i.document.scrollLeft(),
			...
			_position: function () {
				let t = this.uiDialog.is(":visible");
			...
			_destroyOverlay: function () {
				if (this.options.modal && this.overlay) {
					let t = this.document.data("ui-dialog-overlays") - 1;
					(t
		...
		t.widget("ui.droppable", {
			...
			_destroy: function () {
				let e = t.ui.ddmanager.droppables[this.options.scope];
				this._splice(e);
			},
			_setOption: function (e, i) {
				if ("accept" === e)
					...
					let s = t.ui.ddmanager.droppables[this.options.scope];
					(this._splice(s), this._addToManager(i));
				}
				this._super(e, i);
			},
			_activate: function (e) {
				let i = t.ui.ddmanager.current;
			...
			_drop: function (e, i) {
				...
				return s && (s.currentItem || s.element)[0] !== this.element[0]
					? (this.element
							...
							.each(function () {
								let i = t(this).droppable("instance");
	...
	((t.ui.ddmanager = {
				...
				((this.opos = [e.pageX, e.pageY]),
					...
					this.options.disabled ||
						...
						this.selectees.filter(".ui-selected").each(function () {
							let s = t.data(this, "selectable-item");
							((s.startselected = !0),
								e.metaKey ||
									e.ctrlKey ||
		...
		t.widget("ui.selectmenu", [
			t.ui.formResetMixin,
			{
				...
				_create: function () {
					let e = this.element.uniqueId().attr("id");
					((this.ids = {
						element: e,
						button: e + "-button",
						menu: e + "-menu",
					...
					((this.menu = t("<ul>", {
						...
						(this.menuInstance = this.menu
							.menu({
								...
								focus: function (t, i) {
									let s = i.item.data("ui-selectmenu-item");
									(null != e.focusIndex &&
				...
				_selectFocusedItem: function (t) {
					let e = this.menuItems.eq(this.focusIndex).parent("li");
					e.hasClass("ui-state-disabled") ||
						this._select(e.data("ui-selectmenu-item"), t);
				},
				_select: function (t, e) {
					let i = this.element[0].selectedIndex;
				...
				_setAria: function (t) {
					let e = this.menuItems.eq(t.index).attr("id");
					(this.button.attr({
						"aria-labelledby": e,
				...
				_setOption: function (t, e) {
					if ("icons" === t) {
						let i = this.button.find("span.ui-icon");
		...
		t.widget("ui.slider", t.ui.mouse, {
			...
			_handleEvents: {
				...
				keyup: function (e) {
					let i = t(e.target).data("ui-slider-handle-index");
					this._keySliding &&
						((this._keySliding = !1),
						this._stop(e, i),
						this._change(e, i),
		...
		t.widget("ui.sortable", t.ui.mouse, {
			...
			serialize: function (e) {
				...
				return (
					(e = e || {}),
					t(i).each(function () {
						let i = (t(e.item || this).attr(e.attribute || "id") || "").match(
							e.expression || /(.+)[\-=_](.+)/,
						);
						i &&
							s.push(
			...
			_getDragVerticalDirection: function () {
				let t = this.positionAbs.top - this.lastPositionAbs.top;
				return 0 !== t && (t > 0 ? "down" : "up");
			},
			_getDragHorizontalDirection: function () {
				let t = this.positionAbs.left - this.lastPositionAbs.left;
			...
			_removeCurrentsFromItems: function () {
				let e = this.currentItem.find(":data(" + this.widgetName + "-item)");
			...
			_getRelativeOffset: function () {
				if ("relative" === this.cssPosition) {
					let t = this.currentItem.position();
					return {
						top:
							t.top -
							(parseInt(this.helper.css("top"), 10) || 0) +
		...
		t.widget("ui.spinner", {
			...
			_increment: function (e) {
				let i = this.options.incremental;
				return i
					? t.isFunction(i)
						? i(e)
		...
		t.widget("ui.tabs", {
			...
			_tabKeydown: function (e) {
				let i = t(t.ui.safeActiveElement(this.document[0])).closest("li"),
					s = this.tabs.index(i),
					n = !0;
		...
		t.uiBackCompat !== !1 &&
			t.widget("ui.tooltip", t.ui.tooltip, {
				...
				_tooltip: function () {
					let t = this._superApply(arguments);
					return (
