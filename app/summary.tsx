		...
		<View className="flex-1 bg-white">
			...
			>
				<View className="px-5 py-6">
					...
					<ThemedText className="text-base font-google-sans-bold !text-neutral-950 mb-1">
					...
					<View className="flex-row rounded-full bg-[#f3f4f6] p-1 mb-6">
						...
						<View className="flex-1 items-center py-2">
							<ThemedText className="text-[15px] font-google-sans-medium !text-neutral-600">
								Ritorno
							</ThemedText>
							<ThemedText className="text-sm font-google-sans-medium !text-neutral-600">
								19,00 €
					...
					<View className="mb-6">
						<View className="flex-row items-center mb-4">
							<ThemedText className="text-[15px] font-google-sans-medium !text-neutral-600 mr-1">
								Biglietto Singolo
							</ThemedText>
						...
						<View className="flex-row items-center justify-between">
							<View>
								<View className="flex-row items-center mb-1">
									...
									<ThemedText className="ml-1 text-sm font-google-sans-regular !text-neutral-900">
										8825
									</ThemedText>
								</View>
								<ThemedText className="text-[13px] font-google-sans-bold !text-neutral-950">
									{STATIONS[0].name} - {STATIONS[4].name}
								</ThemedText>
				...
				{/* Breakdown Items */}
				<View className="border-t border-neutral-100 px-5 py-5 flex-row items-center justify-between">
					<ThemedText className="text-[16px] font-google-sans-bold !text-neutral-950">
						Altri servizi
					</ThemedText>
					<View className="flex-row items-center">
						<ThemedText className="text-[16px] font-google-sans-bold !text-neutral-950 mr-2">
				...
				<View className="border-t border-b border-neutral-100 bg-[#f9fafb] px-5 py-5 flex-row items-center justify-between">
					<View className="flex-row items-center">
						<ThemedText className="text-[16px] font-google-sans-medium !text-neutral-950 mr-1">
			...
			{/* Bottom Footer */}
			<View
				className="absolute bottom-0 left-0 right-0 bg-white px-5 py-4 flex-row items-center justify-between shadow-lg border-t border-neutral-100"
				style={{ paddingBottom: insets.bottom + 16 }}
			>
				<View>
					<ThemedText className="text-xl font-google-sans-bold !text-neutral-950">
						{addedPrice.toFixed(2).replace(".", ",")} €
					</ThemedText>
					<ThemedText className="text-sm font-google-sans-medium !text-neutral-900">
						1 Viaggio
					</ThemedText>
				</View>
				<View className="w-[55%]">
