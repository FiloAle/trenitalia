				...
				>
					...
					<View className="px-5 gap-4">
						<View className="gap-2">
							...
							>
								...
								<View
									className={`h-5 w-5 rounded-full border-2 items-center justify-center ${selectedMethod === "card" ? "border-teal-900" : "border-gray-300"}`}
								>
									{selectedMethod === "card" && (
										<View className="h-2.5 w-2.5 rounded-full bg-teal-900" />
									)}
								</View>
							</Pressable>
						</View>
								...
								{isOtherMethodsOpen && (
									...
									>
										...
										>
											...
											<View
												className={`h-5 w-5 rounded-full border-2 items-center justify-center ${selectedMethod === "paypal" ? "border-teal-900" : "border-gray-300"}`}
											>
										...
										>
											...
											<View
												className={`h-5 w-5 rounded-full border-2 items-center justify-center ${selectedMethod === "apple_pay" ? "border-teal-900" : "border-gray-300"}`}
											>
										...
										>
											...
											<View
												className={`h-5 w-5 rounded-full border-2 items-center justify-center ${selectedMethod === "satispay" ? "border-teal-900" : "border-gray-300"}`}
											>
										...
										>
											...
											<View
												className={`h-5 w-5 rounded-full border-2 items-center justify-center ${selectedMethod === "amazon_pay" ? "border-teal-900" : "border-gray-300"}`}
											>
										...
										>
											...
											<View
												className={`h-5 w-5 rounded-full border-2 items-center justify-center ${selectedMethod === "mybank" ? "border-teal-900" : "border-gray-300"}`}
											>
					...
					<Animated.View layout={LinearTransition}>
						...
						<View className="px-5 mt-8 mb-6 flex-row items-center justify-between">
							<View className="flex-row items-center">
								<ThemedText className="text-[15px] font-plus-jakarta-medium !text-gray-950 mr-1.5">
									Voglio la fattura
								</ThemedText>
