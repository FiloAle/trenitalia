...
import { View, Pressable, ScrollView, Modal, TextInput, KeyboardAvoidingView, Platform, Keyboard } from "react-native";
...
export function PassengersPanel({
	...
	const [focusedPassengerInputId, setFocusedPassengerInputId] = useState<string | null>(null);
